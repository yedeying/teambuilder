...
router.post('/calendar/add_schedule', function(req, res) {
  var sess = req.session;
  var data = req.body;
  if(data.title === '') {
    res.send({code: 1, info: '标题不能为空'});
...
router.post('/calendar/get_schedule', function(req, res) {
  var sess = req.session;
  var data = req.body;
...
router.post('/calendar/modify_schedule', function(req, res) {
  var sess = req.session;
  var data = req.body;
  if(data.title === '') {
    res.send({code: 1, info: '标题不能为空'});
...
router.post('/calendar/remove_schedule', function(req, res) {
  var sess = req.session;
  var data = req.body;
